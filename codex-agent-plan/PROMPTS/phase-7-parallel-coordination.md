# Parallel Coordination Handoff: Phase 7
...
- /codex-agent-plan/PROMPTS/phase-7-payouts-reporting.md
- /codex-agent-plan/PROMPTS/phase-7-observability-and-audit-completion.md

You are the orchestration agent for Phase 7.

Your job is to launch and coordinate 3 separate implementation agents running in parallel on separate branches. You are not the primary implementation owner of any of these branches.
...
- collect separate report-backs from all implementation agents
...
- payout model and payout status semantics
- provider finance route wiring
- ledger-to-payout aggregation assumptions
- shared logging, audit, and error handling patterns
...
- build on current ledger, earnings, invoke, payment, and observability structures
...
1. feat/provider-payout-execution
2. feat/payouts-reporting
3. feat/observability-and-audit
...
- any docs that should be updated before the final deployment phase
